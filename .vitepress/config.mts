      ...
      '/extensions/': [
        {
          ...
          items: [
            ...
            { text: 'View Contributions', link: '/extensions/views' },
            { text: 'Status Bar Contributions', link: '/extensions/status-bar' },
            { text: 'Store Slice Contributions', link: '/extensions/stores' },
            { text: 'Message Badge Contributions', link: '/extensions/message-badges' },
            { text: 'Conversation Modes', link: '/extensions/conversation-modes' },
            { text: 'Extension API', link: '/extensions/api' },
            { text: 'Tool Contributions', link: '/extensions/tools' },
          ],
        },
      ],
    },
